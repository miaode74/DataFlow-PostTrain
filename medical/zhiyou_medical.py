...
from dataflow.prompts.reasoning.general import GeneralShortCoTGeneratorPrompt


BATCH_SIZE = 500


class ShortCoTText(BatchedPipelineABC):
    def __init__(
        self,
        api_url: str,
        model_name: str,
        ...
        # 使用通用推理回答生成的 prompt（可根据需要换成自定义 medical prompt）
        self.prompt = GeneralShortCoTGeneratorPrompt()
...
if __name__ == "__main__":
    ...
    #  medqa-usmile: /share/project/xzy_datas_models/infinity/Medical/seeds/medqa_usmile_instruction_only.jsonl
    #  medmcqa: /share/project/xzy_datas_models/infinity/Medical/seeds/medmcqa_instruction_only.jsonl
