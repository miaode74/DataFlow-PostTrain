...
from prompt_temp import PhysicsPrompt
...
class PhysicsQuestionGenerator(OperatorABC):
    def __init__(self,
                num_prompts: int = 1,
                llm_serving: LLMServingABC = None,
                prompt_template = PhysicsPrompt(),
    ...
    def _reformat_prompt(self, dataframe):
        ...
        for selected_item in selected_items:
            for question in dataframe[self.input_key]:
                used_prompt = self.prompts.build_physics_prompt(selected_item, question)
